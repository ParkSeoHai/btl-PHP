...
const btnSubmit = formAdd.querySelector('.btn-submit');
...
btnSubmit.addEventListener('click', (e) => {
    ...
    const clearMessage = () => {
        const messages = formAdd.querySelectorAll('.error-message');
        if(messages) {
    ...
    // Xử lý seclect
    const options = formAdd.querySelectorAll('.form-select option');
