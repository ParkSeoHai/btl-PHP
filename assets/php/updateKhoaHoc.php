...
if (isset($_POST['courseId']) && isset($_POST['courseName']) && isset($_POST['description']) && isset($_POST['teacherId'])
    ...
    echo $courseName . ' ' . $description . ' ' . $teacherId . ' ' . $coursePrice . ' ' . $id;
    ...
    try {
        ...
        $adminController->updateCourse($id, $courseName, $description, $url, $coursePrice, $teacherId);
    } catch (Exception $e) {
